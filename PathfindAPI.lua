...
function _G.Pathfind:init( callback )
    ...
    Player.CharacterAdded:Connect(function(char) char.Humanoid.MoveToFinished:Connect(new_waypoint); end)
    Player.Character.Humanoid.MoveToFinished:Connect(new_waypoint);
